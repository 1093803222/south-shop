...
class OrderLogic
{
	 ...
	 * @param int $admin_id|用户下单的商品所属的商户
	 * @return array
	 */
	public function addOrder($user_id,$address_id,$shipping_code,$invoice_title,$coupon_id = 0,$car_price=[],$user_note='',$pay_name='',$admin_id='')
	{
		...
		$data = array(
                ...
                'admin_id'         =>$admin_id,   // 用户下单的商品所属的商户
		);
		$order = new Order();
