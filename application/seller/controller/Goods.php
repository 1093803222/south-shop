...
//        var_dump($GoodsLogic);die;
    ...
    public function ajaxGoodsList(){            
        ...
        $where = " 1 = 1 and admin_id = {$adminID} "; // 搜索条件
    ...
    public function addEditGoods()
    {
        ...
        if ((I('is_ajax') == 1) && IS_POST) {
            ...
            $return_url = $is_distribut > 0 ? U('seller/Distribut/goods_list') : U('seller/Goods/goodsList');
            $data = input('post.');
            ...
            if ($type == 2) {
                ...
                $Goods->admin_id = session('admin_id'); // 所属商户id
                $Goods->save(); // 写入数据到数据库
                    ...
                    {                          
                        ...
                        $this->ajaxReturn($return_arr);
                             ...
                             $return_arr = array(
                                 'status' => 1,
                                 'msg'   => '操作成功',                        
                                 'data'  => array('url'=>U('Seller/Goods/goodsAttributeList')),
                             );
                             $this->ajaxReturn($return_arr);
                }  
            }                
    ...
    public function delGoodsAttribute()
    {
        ...
        $this->ajaxReturn(['status' => 1,'msg' => "操作成功!",'url'=>U('Seller/Goods/goodsAttributeList')]);
    }            
    ...
    public function delGoodsSpec()
    {
        ...
        $this->ajaxReturn(['status' => 1,'msg' => "操作成功!!!",'url'=>U('Seller/Goods/specList')]);
    } 
